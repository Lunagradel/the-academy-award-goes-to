<template>
  <div class="category">
    ...
    <div class="nominees">
        <div class="nominee" v-bind:class="[vote && (vote.willWin === nominee.id ? vote.shouldWin === nominee.id ? 'active-nom-both' : 'active-nom-will-win' : vote.shouldWin === nominee.id ? 'active-nom-should-win' : ''), category && vote && category.winner === nominee.id && 'nom-winner' ]" v-for="nominee in category.nominees" :key="nominee.id">
